...
FEDORA_BASE_URL="http://mirrors.kernel.org/fedora-secondary/releases/20/Fedora/${ARCH}"
IMAGE="fedora20_${ARCH}.qcow2"

ISO="$FEDORA_BASE_URL/iso/Fedora-20-${ARCH}-netinst.iso"
VMLINUX="$FEDORA_BASE_URL/os/ppc/ppc64/vmlinuz"
INITRD="$FEDORA_BASE_URL/os/ppc/ppc64/initrd.img"

KICKSTART="fedora20.ks"
